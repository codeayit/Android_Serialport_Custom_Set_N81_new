...
public class MainActivity extends Activity {
    ...
    CheckBox checkBoxAutoClear, checkBoxAutoCOMA, checkBoxEnter;
    ...
    private void setControls() {
        ...
        checkBoxEnter = (CheckBox) findViewById(R.id.checkBoxEnter);
...
//		}
    ...
    private void sendPortData(SerialHelper ComPort, String sOut) {
        if (ComPort != null && ComPort.isOpen()) {
            if (checkBoxEnter.isChecked()){
                sOut = sOut+ new String(new char[]{0x0D, 0x0A});
            }
            if (radioButtonTxt.isChecked()) {
